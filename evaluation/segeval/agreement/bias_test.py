...
class TestBias(unittest.TestCase):
    ...
    def test_bias_g5(self):
        ...
        self.assertAlmostEqual(bias, Decimal('0.00277829320319822615823397979'))
    ...
    def test_bias_g5_ch1(self):
        ...
        self.assertTrue(bias > 0)
        self.assertAlmostEqual(bias, Decimal('0.00390625000000000000000000011'))
    ...
    def test_bias_g2(self):
        ...
        self.assertTrue(bias > 0)
        self.assertAlmostEqual(bias, Decimal('0.00393636062003502686364542151'))
    ...
    def test_bias_g2_ch2(self):
        ...
        bias = artstein_poesio_bias_linear(data)
        self.assertTrue(bias > 0)
        self.assertAlmostEqual(bias, Decimal('0.00090702947845804988662131528'))
